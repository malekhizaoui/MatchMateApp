...
export const ScreenOptions = ({ navigation, route }:any) => ({
  ...
  tabBarIcon: ({ focused, color }:any) => {
    ...
    if (route.name === 'HomeTab') {
      iconName = focused ? <HomeIconSVG color={MatchMatePalette.primaryColor} /> : <HomeIconSVG color={MatchMatePalette.whiteColor} />;
      name = 'Home';
    } else if (route.name === 'ProfileTab') {
      iconName = focused ? <ProfileIconSVG color={MatchMatePalette.primaryColor} /> : <ProfileIconSVG color={MatchMatePalette.whiteColor} />;
      name = 'Profile';
    } else if (route.name === 'LeaderboardTab') {
      iconName = focused ? <LeaderboardIconSCG color={MatchMatePalette.primaryColor} /> : <LeaderboardIconSCG color={MatchMatePalette.whiteColor} />;
      name = 'Leaderboard';
    } else if (route.name === 'BookingTab') {
      iconName = focused ? <BookingIconSVG color={MatchMatePalette.primaryColor} /> : <BookingIconSVG color={MatchMatePalette.whiteColor} />;
      name = 'Booking';
